                                ...
                                <div class="col-md-12">
                                    <div class="account-create-box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12">
                                                <p class="for-newsletter"><input type="checkbox" name="newsletter" value="yes"/> Sign Up for Newsletter</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="account-create-box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <div class="single-create">
                                                    ...
                                                    <input class="form-control" type="password" name="user_pass_conf"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="submit-area">
                                        ...
                                        <button type="submit" class="btn btn-primary floatright" name="submit">submit</button>
                    ...
                    <form method="POST" action="#" class="col-md-6 col-xs-12">
                        <div class="checkout-collapse">
                            ...
                            <div class="form-group">
                                <label>E-mail</label>
                                <input type="email" class="form-control" name="control_email">
                            </div>
                            <div class="form-group">
                                <label>Password</label>
                                <input type="password" class="form-control" name="control_pass">
                                <a href="#">Forgotten Password</a>
                            </div>
                            <input type="submit" class="btn btn-primary" value="Login" name="control_submit">
                        </div>
                        <span class="thank">
                            <?php
